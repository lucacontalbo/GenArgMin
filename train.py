...
class Trainer:
        ...
        for batch in tqdm(train_loader, desc='Iteration'):
            ...
            if self.config["adversarial"]:
                ...
                if self.config["use_graph"]:
                    out = model(ids_sent1, segs_sent1, att_mask_sent1, sentence1, sentence2)
                else:
    ...
    def visualize(self, model, test_dataloader, config):
        ...
        for i,batch in enumerate(test_dataloader):
            ...
            ids_sent1, segs_sent1, att_mask_sent1, node_bounds, labels = batch
            ...
            with torch.no_grad():
                out = model(ids_sent1, segs_sent1, att_mask_sent1, node_bounds, visualize=True)
