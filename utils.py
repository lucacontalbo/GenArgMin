...
def get_config():
    ...
    parser.add_argument('--use_graph', action="store_true", required=False, help='use graph features')
    parser.add_argument('--generated_max_length', type=int, required=False, default=1024, help='max sequence length for each generated sample')
    parser.add_argument('--k', type=int, required=False, default=20, help='number of text spans to keep for generation')
    parser.add_argument('--scheduler', action="store_true", required=False, help='use lr scheduling')
